...
class completeFlatScreen extends StatelessWidget {
  @override
    ...
    return BlocConsumer<studentLayoutcubit, studentLayoutstates>(
      ...
      builder: (context, state) {
        return ConditionalBuilder(
          ...
          condition: studentLayoutcubit.get(context).completeFlatCases.length > 0,
          builder: (context) => Scaffold(
            appBar: defaultAppBar(
              context: context,
              title: 'Flat Ridge Cases',
            ),
              ...
              child: Column(children: [
                ListView.separated(
                  ...
                  itemBuilder: (context, index) => studentDefaultbuildPost(
                    studentLayoutcubit.get(context).completeFlatCases[index],
                    context,
                    studentPostScreen(),
                  ...
                  itemCount: studentLayoutcubit.get(context).completeFlatCases.length,
                ),
                SizedBox(
                  height: 8.0,
                ),
