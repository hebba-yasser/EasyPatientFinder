...
class completeDentureScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<studentLayoutcubit, studentLayoutstates>(      listener: (context, state) {},
                      ...
                      children: [
                        Expanded(
                          ...
                          child: defaultbutton(
                            ...
                            text: 'Flat Ridge',textalign:TextAlign.center ,
                            radius: 30,
                            width: 20,
                          ),
                        ),
                        ...
                        Expanded(
                          ...
                          child: defaultbutton(
                            ...
                            text: 'Well Developed Ridge',textalign:TextAlign.center ,
                            radius: 30,
                          ),
                        ),
