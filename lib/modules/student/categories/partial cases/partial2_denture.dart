...
class partial2Screen extends StatelessWidget {
  @override
    ...
    return BlocConsumer<studentLayoutcubit, studentLayoutstates>(
      ...
      builder: (context, state)
      {
        return ConditionalBuilder(
          ...
          condition: studentLayoutcubit.get(context).partialCases2.length > 0,
              ...
              child: Column(children: [
                ListView.separated(
                  ...
                  itemBuilder: (context, index) => studentDefaultbuildPost(
                    studentLayoutcubit.get(context).partialCases2[index],
                    context,
                    studentPostScreen(),
                  ...
                  itemCount: studentLayoutcubit.get(context).partialCases2.length,
                ),
                SizedBox(
                  height: 8.0,
                ),
