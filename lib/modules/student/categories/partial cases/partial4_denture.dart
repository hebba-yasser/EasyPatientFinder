...
class partial4Screen extends StatelessWidget {
  @override
    ...
    return BlocConsumer<studentLayoutcubit, studentLayoutstates>(
      ...
      builder: (context, state)
      {
        return ConditionalBuilder(
          ...
          condition: studentLayoutcubit.get(context).partialCases4.length > 0,
          builder: (context) => Scaffold(
            appBar: defaultAppBar(
              context: context,
              title: 'kennedy |v Cases',
            ),
              ...
              child: Column(children: [
                ListView.separated(
                  ...
                  itemBuilder: (context, index) => studentDefaultbuildPost(
                    studentLayoutcubit.get(context).partialCases4[index],
                    context,
                    studentPostScreen(),
                  ...
                  itemCount: studentLayoutcubit.get(context).partialCases4.length,
                ),
                SizedBox(
                  height: 8.0,
                ),
